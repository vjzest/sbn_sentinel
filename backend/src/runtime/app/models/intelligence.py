...
class DecisionContextModel(Base):
    ...
    sufficiency_status = Column(String, nullable=True, default=None)
    operational_target_reference = Column(String, nullable=True)
    operational_target_type = Column(String, nullable=True)
