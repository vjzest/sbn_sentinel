...
api_router.include_router(reality_connectors.router, prefix="/reality", tags=["000_Reality_Connectors"], dependencies=[Depends(RoleChecker(["clinic_admin", "super_admin"]))])
