...
export const CriticalStateBanner: React.FC<CriticalStateBannerProps> = ({ state, reason }) => {
  ...
  return (
    <div className="bg-[var(--color-semantic-critical)]/10 border-s-4 border-[var(--color-semantic-critical)] p-4 rounded-e-[12px] flex items-start gap-3 my-2" role="alert">
